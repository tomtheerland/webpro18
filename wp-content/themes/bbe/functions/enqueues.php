...
function bbe_customizable_inline_css() {
	...
	if(get_theme_mod('bbe_menubar_bgcolor')!="") $css.="nav#main-nav {background: ". get_theme_mod('bbe_menubar_bgcolor')."; } ";
...
function bbe_footer_codes() {
	...
	if (isset($post->post_content) && strpos(($post->post_content), 'bbe-facebook-helper') !== false): ?>
	<!-- fb -->
	<div id="fb-root"></div>
	...
	<?php
	if (isset($post->post_content) && strpos(($post->post_content), 'bbe-twitter-helper') !== false): ?>
	<!-- TW -->
