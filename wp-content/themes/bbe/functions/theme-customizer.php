...
function bbe_register_main_partials( WP_Customize_Manager $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'bbe_inline_css', array(
        ...
        'settings' => array( 'bbe_footer_bgcolor','bbe_menubar_bgcolor' , 'bbe_links_color','bbe_hover_links_color','bbe_headings_font','bbe_body_font'  ),
		'render_callback' => function() {
...
function bbetheme_customize_register_extras($wp_customize) 
{
	...
	//COLORS: MENUBAR BG COLOR
	$wp_customize->add_setting(  'bbe_menubar_bgcolor',  array(
	 ...
	 $wp_customize,
	 'bbe_menubar_bgcolor', //give it an ID
	 array(
	 'label' => __( 'Menu Bar Background Color', 'bbe' ), //set the label to appear in the Customizer
	 'section' => 'colors', //select the section for it to appear under 
	 'settings' => 'bbe_menubar_bgcolor' //pick the setting it applies to
		)
	 ));
